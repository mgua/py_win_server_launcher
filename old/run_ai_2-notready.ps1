...
Start-Process "wt.exe" -ArgumentList "--pos 010,010","--size 080,015","--title `"ollama server`"","--colorScheme `"Campbell Powershell`"","powershell -NoExit -Command $ollama_command"
# ---------------------------------------------------------------------------
...
Start-Process "wt.exe" -ArgumentList "--pos 010,500","--size 080,015","--title `"tailor server`"","--colorScheme `"Solarized Light`"","powershell -NoExit -Command $tailor_fe_command"
# ---------------------------------------------------------------------------
...
Start-Process "wt.exe" -ArgumentList "--pos 900,010","--size 080,015","--title `"Gufo frontend`"","--colorScheme `"Solarized Dark`"","powershell -NoExit -Command $gufo_command"
# ---------------------------------------------------------------------------
#
#
function Launch_Mail_Processor {
    ...
    Start-Process "wt.exe" -ArgumentList "--pos 900,500","--size 080,015","--title `"mail processor`"","--colorScheme `"One Half Dark`"","powershell -NoExit -Command $mail_processor_command"
}
# ---------------------------------------------------------------------------
